...
(NAME, DEGREE, DEPARTMENT, YEAR, FATHER_NAME, GENDER, DOB, BLOOD, BODY_WEIGHT, EMAIL, ADDRESS, AREA, CITY, PINCODE, STATE, CONTACT_1, CONTACT_2, VOLUNTARY, VOLUNTARY_GROUP,NEW_DONOR, LAST_D_DATE, DONOR_PIC,COUNTRY)
 VALUES 
 ('{$_POST["NAME"]}', '{$_POST["DEGREE"]}', '{$_POST["DEPARTMENT"]}', '{$_POST["YEAR"]}',  '{$_POST["FATHER_NAME"]}', '{$_POST["GENDER"]}', '{$_POST["DOB"]}', '{$_POST["BLOOD"]}', '{$_POST["BODY_WEIGHT"]}', '{$_POST["EMAIL"]}', '{$_POST["ADDRESS"]}', '{$_POST["AREA"]}', '$cityname', '{$_POST["PINCODE"]}', '{$state}', '{$_POST["CONTACT_1"]}', '{$_POST["CONTACT_2"]}', '{$_POST["VOLUNTARY"]}', '{$_POST["VOLUNTARY_GROUP"]}', '{$_POST["NEW_DONOR"]}','{$_POST["LAST_D_DATE"]}', '{$img}','{$country}');";
						if($con->query($sql))
							{
								echo '
				...
				?>
				<h3 class="eligibility_page">Please Read Eligibility Page Before Donor Registration <a href='eligibility.php'>Go To Eligibility Page</a></h3>
				<br><br>

                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><i class="fa-solid fa-user-plus"></i> JOIN AS BLOOD DONOR</h3>
                    </div>
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
								<label class="control-label text-primary" for="DEGREE">Degree</label>
							...
							<div class="form-group">
								<label class="control-label text-primary" for="STATE">Department</label>
								...
								<option value="Commerce With Computer Application">Commerce With Computer Application</option>
						  	...
						  	<div class="form-group">
								<label class="control-label text-primary" for="CITY" >Year of Studying</label>
                                <select name="YEAR" id="YEAR_OF_STUDYING" required class="form-control">
						...
						<div class="form-group">
							<label class="control-label text-primary" for="FATHER_NAME">Father's Name</label>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						  ...
						  <hr>
						   <!-- <div class="form-group">
								<label class="control-label text-primary"><input type="checkbox" id="c1" >&nbsp; Voluntary</label>
							</div> -->
							<div id="volu">
							<div class="form-group">
    							<label class="control-label text-primary">Voluntary Donor</label>
						 ...
						 <div class="form-group">
						 <label class="control-label text-primary" for="VOLUNTARY_GROUP" >Voluntary Organization/Group Name</label>
						 	<input type="text"  name="VOLUNTARY_GROUP" id="VOLUNTARY_GROUP"  class="form-control" placeholder="Voluntary Group Name" value="Nil">
						 </div>
						  ...
						  <div class="form-group">
							...
							<input type="file" class="form-control"  name="fileToUpload">
							  ...
							  <div class="form-group">
								<label class="control-label text-primary"><input type="checkbox" checked id="c2">&nbsp; I have read the eligibility criteria and confirm that i am eligible to donate blood.</label> 
								<label class="control-label text-primary"><input type="checkbox" checked id="c3" >&nbsp; I agree to the Term and Conditions and consent to have my contact and donor information published to the potential blood recipients.</label>
						  </div>
						
					
						
						  <div class="form-group">
							<button class="btn btn-primary" type="submit" name="submit"><i class="fa-solid fa-person-circle-plus"></i> Registar Now</button>
						  </div>
						 </form>
                    </div>
                </div>
 ...
 <script>
  ...
  // update the Year of Studying dropdown based on the selected Degree
  $(document).ready(function() {
    $("#DEGREE").change(function() {
      ...
      if (degree == "UG") {
        yearOptions = "<option value='select'>Select Year of Studying<option value='I'>I</option><option value='II'>II</option><option value='III'>III</option>";
      } else if (degree == "PG") {
        yearOptions = "<option value='select'>Select Year of Studying<option value='I'>I</option><option value='II'>II</option>";
      }

      $("#YEAR_OF_STUDYING").html(yearOptions);
    });
  });
