...
<ul class="nav nav-stacked">
	...
	<li><a href="admin_donor.php"><i class="fa-solid fa-hand-holding-droplet"></i> Registered Donor</a></li>
	<li><a href="admin_need_blood.php"><i class="fa-solid fa-hospital-user"></i> Registered Receiver</a></li>
	...
	<ul class="nav collapse" id="add">
		<li><a href="admin_country.php"><i class="fa fa-plus fa-lg"></i> Add Country</a></li>
