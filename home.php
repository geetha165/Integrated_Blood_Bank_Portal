            ...
            <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="Donor_reg.php" class="btn btn-primary"> Register <i class="fa-solid fa-user-plus"></i> </a>
                    </div>
                </div>
            </div>
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-medkit"></i> Receiver Registration</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <a href="request_blood.php" class="btn btn-primary">Register <i class="fa-solid fa-user-plus"></i></a>
                    </div>
                </div>
            </div>
			  ...
			  <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="Search_Donor.php" class="btn btn-primary">Search <i class="fa fa-fw fa-search"></i></a>
                    </div>
                </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="well">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a class="btn btn-primary btn-block" href="contact.php"><i class="fa fa-send"></i>  Send a Message</a>
                </div>
            </div>
        </div>
