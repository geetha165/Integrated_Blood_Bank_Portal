...
// Modified query to check for active donors (STATUS = 1)
$sql = "SELECT * FROM blood_donor WHERE BLOOD='$blood_group' AND STATUS=1";
...
if($result->num_rows > 0) {
    ...
    echo "<div class='alert alert-danger'><i class='fa fa-users'></i> No Active Donors Found for Blood Group: $blood_group</div>";
}
?>
